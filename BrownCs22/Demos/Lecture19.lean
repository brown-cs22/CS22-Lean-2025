...
import BrownCs22.Library.Tactic.ModSubst.ModRel
...
# Lecture 19 Lean notes

We've been using Lean in homeworks.
  ...
  { simp [hba]
    ...
    { simp [ha]
      ...
      { dsimp [Dvd.dvd] at hl hr ⊢
        ...
        zify at hqr hm hk ⊢
        linear_combination hk + (b / a : ℤ) * hm - hqr } } }
  done
...
to each side. (We've used this a few times already...)
-/
...
But we don't really use this as a lemma: we use it as a *tool*
during calculations.
